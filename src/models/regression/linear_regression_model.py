...
Description:
    Train and evaluate a Linear Regression baseline for
...
PREPROCESSOR_ARTIFACT_PATH = (
    ARTIFACTS_DIR
    / "linear_regression_preprocessor.pkl"
)
...
def train_linear_regression() -> dict[str, float]:
    """
    ...
    print(
        "LINEAR REGRESSION BASELINE SUMMARY"
    )
    print(
        "=" * 60
    )
