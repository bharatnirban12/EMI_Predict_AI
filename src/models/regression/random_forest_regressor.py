...
Description:
    Train and evaluate a Random Forest Regressor baseline
    for maximum monthly EMI prediction.
...
PREPROCESSOR_ARTIFACT_PATH = (
    ARTIFACTS_DIR
    / "random_forest_regressor_preprocessor.pkl"
)
...
def train_random_forest() -> dict[str, float]:
    ...
    """
    logger.info(
        "Starting Random Forest Regression training."
    )
    ...
    print(
        "RANDOM FOREST REGRESSION BASELINE SUMMARY"
    )
    print(
        "=" * 60
    )
